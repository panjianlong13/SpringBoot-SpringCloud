package com.peter.springboot.lucene;

import com.chenlb.mmseg4j.analysis.ComplexAnalyzer;
import com.peter.springboot.lucene.utils.LuceneUtils;
...
public class BaseTest {
	...
	public void updateDocumentTest() throws IOException {
		...
		System.out.println("updateDocumentTest");
	...
	public void termQueryTest() throws IOException {
		...
		System.out.println("termQueryTest");
	...
	public void prefixQueryTest() throws IOException {
		...
		System.out.println("prefixQueryTest");
	 ...
	 * 短语搜索
	 * <p>
	 * 所谓PhraseQuery，就是通过短语来检索，比如我想查“big car”这个短语， 那么如果待匹配的document的指定项里包含了"big
	 * car"这个短语， 这个document就算匹配成功。可如果待匹配的句子里包含的是“big black car”，
	...
	public void phraseQueryTest() throws IOException {
		...
		System.out.println("phraseQueryTest");
	...
	public void wildcardQueryTest() throws IOException {
		...
		System.out.println("wildcardQueryTest");
	...
	public void queryParserTest() throws IOException, ParseException {
		...
		System.out.println("queryParserTest");
	...
	public void multiFieldQueryParserTest() throws IOException, ParseException {
		...
		System.out.println("multiFieldQueryParserTest");
	...
	public void HighlighterTest() throws IOException, ParseException, InvalidTokenOffsetsException {
		...
		System.out.println("HighlighterTest");
